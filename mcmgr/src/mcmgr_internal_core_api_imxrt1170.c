...
#if defined(FSL_FEATURE_MU_SIDE_A)
    IOMUXC_LPSR_GPR->GPR0 = IOMUXC_LPSR_GPR_GPR0_CM4_INIT_VTOR_LOW((uint32_t)(char *)bootAddress);
...
/* When kicking off the CM7 core from the CM4 core */
    ...
    {
        IOMUXC_LPSR_GPR->GPR26 = IOMUXC_LPSR_GPR_GPR26_CM7_INIT_VTOR((uint32_t)(char *)bootAddress);
    }
...
{
#if defined(FSL_FEATURE_MU_SIDE_A)
    if (0U == (OCOTP->FUSE022 & BT_CORE_SEL_BIT))
    {
